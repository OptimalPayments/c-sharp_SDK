<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hosted-payment-silent.aspx.cs" Inherits="SampleApp.hosted_payment_silent" %>
...
<body>
    ...
    <% }
       else if (silent_post_url != null)
       { %>
    <form id="silentPostForm" runat="server">
        <fieldset>
            <legend>Card Details For Order ID: <% Response.Write(order_id); %></legend>
            <div>
                <label>
                    Card Number: 
						<input type="text" autocomplete="off" name="cardNum" value="4444333322221111" />
                </label>
            </div>
            <div>
                <label>
                    CVV: 
						<input type="text" autocomplete="off" name="cvdNumber" value="123" />
                </label>
            </div>
            <div>
                <label>
